// ===========================================
// SISTEMA DE GEOREFERENCIACIÓN CON MAPA SIMPLE
// ===========================================

class LocationSystemSimpleMap {
    constructor() {
    ...
    startLocationDetection() {
        console.log('Iniciando sistema de ubicación con mapa simple...');
        
        // Mostrar interfaz del mapa inmediatamente
    ...
    showMapInterface() {
        ...
        locationInfo.innerHTML = `
            <div class="location-map-container">
                <div class="location-map-header">
                    <h3>🗺️ Selecciona Tu Ubicación</h3>
                    <p>Haz clic en una ciudad del mapa para detectar tu ubicación</p>
                </div>
                <div class="location-map-wrapper">
                    <div class="simple-map">
                        <div class="map-grid">
                            <div class="map-region" data-city="bogota" data-lat="4.6097" data-lng="-74.0817">
                                <div class="city-marker">📍</div>
                                <div class="city-name">Bogotá</div>
                            </div>
                            <div class="map-region" data-city="medellin" data-lat="6.2442" data-lng="-75.5812">
                                <div class="city-marker">📍</div>
                                <div class="city-name">Medellín</div>
                            </div>
                            <div class="map-region" data-city="cali" data-lat="3.4516" data-lng="-76.5320">
                                <div class="city-marker">📍</div>
                                <div class="city-name">Cali</div>
                            </div>
                            <div class="map-region" data-city="barranquilla" data-lat="10.9685" data-lng="-74.7813">
                                <div class="city-marker">📍</div>
                                <div class="city-name">Barranquilla</div>
                            </div>
                            <div class="map-region" data-city="cartagena" data-lat="10.3910" data-lng="-75.4794">
                                <div class="city-marker">📍</div>
                                <div class="city-name">Cartagena</div>
                            </div>
                            <div class="map-region" data-city="bucaramanga" data-lat="7.1193" data-lng="-73.1227">
                                <div class="city-marker">📍</div>
                                <div class="city-name">Bucaramanga</div>
                            </div>
                            <div class="map-region" data-city="pereira" data-lat="4.8133" data-lng="-75.6961">
                                <div class="city-marker">📍</div>
                                <div class="city-name">Pereira</div>
                            </div>
                            <div class="map-region" data-city="santa_marta" data-lat="11.2408" data-lng="-74.2110">
                                <div class="city-marker">📍</div>
                                <div class="city-name">Santa Marta</div>
                            </div>
                            <div class="map-region" data-city="ibague" data-lat="4.4447" data-lng="-75.2437">
                                <div class="city-marker">📍</div>
                                <div class="city-name">Ibagué</div>
                            </div>
                            <div class="map-region" data-city="manizales" data-lat="5.0689" data-lng="-75.5174">
                                <div class="city-marker">📍</div>
                                <div class="city-name">Manizales</div>
                            </div>
                            <div class="map-region" data-city="villavicencio" data-lat="4.1420" data-lng="-73.6268">
                                <div class="city-marker">📍</div>
                                <div class="city-name">Villavicencio</div>
                            </div>
                            <div class="map-region" data-city="pasto" data-lat="1.2059" data-lng="-77.2858">
                                <div class="city-marker">📍</div>
                                <div class="city-name">Pasto</div>
                            </div>
                            <div class="map-region" data-city="neiva" data-lat="2.9345" data-lng="-75.2809">
                                <div class="city-marker">📍</div>
                                <div class="city-name">Neiva</div>
                            </div>
                            <div class="map-region" data-city="armenia" data-lat="4.5363" data-lng="-75.6811">
                                <div class="city-marker">📍</div>
                                <div class="city-name">Armenia</div>
                            </div>
                            <div class="map-region" data-city="popayan" data-lat="2.4448" data-lng="-76.6147">
                                <div class="city-marker">📍</div>
                                <div class="city-name">Popayán</div>
                            </div>
                            <div class="map-region" data-city="valledupar" data-lat="10.4631" data-lng="-73.2532">
                                <div class="city-marker">📍</div>
                                <div class="city-name">Valledupar</div>
                            </div>
                            <div class="map-region" data-city="monteria" data-lat="8.7500" data-lng="-75.8833">
                                <div class="city-marker">📍</div>
                                <div class="city-name">Montería</div>
                            </div>
                            <div class="map-region" data-city="tunja" data-lat="5.5353" data-lng="-73.3678">
                                <div class="city-marker">📍</div>
                                <div class="city-name">Tunja</div>
                            </div>
                            <div class="map-region" data-city="florencia" data-lat="1.6174" data-lng="-75.6062">
                                <div class="city-marker">📍</div>
                                <div class="city-name">Florencia</div>
                            </div>
                            <div class="map-region" data-city="yopal" data-lat="5.3480" data-lng="-72.4030">
                                <div class="city-marker">📍</div>
                                <div class="city-name">Yopal</div>
                            </div>
                            <div class="map-region" data-city="quibdo" data-lat="5.6909" data-lng="-76.6586">
                                <div class="city-marker">📍</div>
                                <div class="city-name">Quibdó</div>
                            </div>
                            <div class="map-region" data-city="arauca" data-lat="7.0903" data-lng="-70.7617">
                                <div class="city-marker">📍</div>
                                <div class="city-name">Arauca</div>
                            </div>
                            <div class="map-region" data-city="leticia" data-lat="-4.2153" data-lng="-69.9406">
                                <div class="city-marker">📍</div>
                                <div class="city-name">Leticia</div>
                            </div>
                            <div class="map-region" data-city="sincelejo" data-lat="9.3047" data-lng="-75.3978">
                                <div class="city-marker">📍</div>
                                <div class="city-name">Sincelejo</div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="location-map-actions">
                    <button class="btn-location" onclick="locationSystemSimpleMap.showLocationSelector()" style="background: linear-gradient(135deg, #6b7280, #4b5563);">
                        📋 Lista de Municipios
                    </button>
                    <button class="btn-location" onclick="locationSystemSimpleMap.tryAutoDetection()" style="background: linear-gradient(135deg, #10b981, #059669);">
                        📍 Mi Ubicación Actual
                    </button>
                </div>
            </div>
        ...
        // Agregar eventos a las ciudades
        this.addCityEvents();
    }

    // Agregar eventos a las ciudades
    addCityEvents() {
        const cityElements = document.querySelectorAll('.map-region');
    ...
    getMapPosition(lat, lng) {
        ...
        const x = ((lng - colombiaBounds.west) / (colombiaBounds.east - colombiaBounds.west)) * 100;
        const y = ((lat - colombiaBounds.south) / (colombiaBounds.north - colombiaBounds.south)) * 100;
        
        // Ajustar para que esté dentro del mapa
        return {
        ...
        if (this.detectedMunicipality) {
            locationInfo.innerHTML = `
                ...
                <div class="location-map-visual">
                    <h4>🗺️ Mapa de Colombia - Tu Ubicación</h4>
                    <div class="mini-map">
                        <div class="map-container">
                            <div class="colombia-outline">
                                <div class="location-marker" style="left: ${this.getMapPosition(this.detectedMunicipality.coordinates.lat, this.detectedMunicipality.coordinates.lng).x}%; top: ${this.getMapPosition(this.detectedMunicipality.coordinates.lat, this.detectedMunicipality.coordinates.lng).y}%;">
                                    <div class="marker-pin">📍</div>
                                    <div class="marker-label">${this.detectedMunicipality.name}</div>
                                </div>
                            </div>
                        </div>
                        <div class="map-info">
                ...
                <div class="location-actions">
                    <button class="btn-location" onclick="locationSystemSimpleMap.showMunicipalityModal()">
                        📊 Ver Información de Mi Zona
                    </button>
                    <button class="btn-location" onclick="locationSystemSimpleMap.showMapInterface()" style="background: linear-gradient(135deg, #6b7280, #4b5563);">
                        🗺️ Cambiar Ubicación
                    </button>
                </div>
            `;
    ...
    showLocationFallback() {
        ...
        locationInfo.innerHTML = `
            ...
            <div class="location-actions">
                <button class="btn-location" onclick="locationSystemSimpleMap.showLocationSelector()">
                    🗺️ Seleccionar Mi Zona
                </button>
                <button class="btn-location" onclick="locationSystemSimpleMap.showMapInterface()" style="background: linear-gradient(135deg, #10b981, #059669);">
                    🗺️ Ver Mapa de Ciudades
                </button>
                <button class="btn-location" onclick="locationSystemSimpleMap.tryAutoDetection()" style="background: linear-gradient(135deg, #f59e0b, #d97706);">
                    🔄 Intentar Nuevamente
                </button>
            </div>
        `;
                    ...
                    <div class="departamento-section">
                        ...
                        <div class="municipios-grid">
                            ${departamento.municipios.slice(0, 5).map(municipio => `
                                <button class="location-option" onclick="locationSystemSimpleMap.selectMunicipality('${municipio.nombre.toLowerCase().replace(/\s+/g, '_')}')">
                                    🏘️ ${municipio.nombre}
                                </button>
                            `).join('')}
                            ${departamento.municipios.length > 5 ? `
                                <button class="location-option more-options" onclick="locationSystemSimpleMap.showMoreMunicipios('${departamentoId}')">
            ...
            <div class="location-modal-content">
                ...
                <div class="location-modal-body">
                    <div class="search-box">
                        <input type="text" id="municipioSearch" placeholder="🔍 Buscar municipio..." onkeyup="locationSystemSimpleMap.filterMunicipios(this.value)">
                    </div>
        ...
        modal.innerHTML = `
            <div class="municipality-modal-content">
                ...
                <div class="municipality-actions">
                    ...
                    <button class="btn-download" onclick="locationSystemSimpleMap.downloadMunicipalityInfo()">
                        💳 Descargar PDF ($3.000)
                    </button>
                </div>
            </div>
...
// Inicializar sistema de ubicación con mapa simple
window.locationSystemSimpleMap = new LocationSystemSimpleMap();

// Exportar para uso global
window.LocationSystemSimpleMap = LocationSystemSimpleMap;
